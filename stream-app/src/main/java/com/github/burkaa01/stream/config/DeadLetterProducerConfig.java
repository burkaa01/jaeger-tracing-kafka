...
public class DeadLetterProducerConfig {
    ...
    public DeadLetterProducerConfig(KafkaProperties kafkaProperties) {
        this.kafkaProperties = kafkaProperties;
    }

    @Bean
    public KafkaTemplate<String, Integer> deadLetterTemplate() {
        return new KafkaTemplate<>(deadLetterProducerFactory());
    }

    @Bean
    public ProducerFactory<String, Integer> deadLetterProducerFactory() {
